...
function resumeLooktable( ) {
    ...
    try {
        idusers = window.parent.document.getElementById("userID").value;
        idname = window.parent.document.getElementById("userLogin").value;
        console.log(idusers + " resumeLooktable " + idname);
    }
    catch (e) {
        console.log("ZERO PRA TI");
    }
