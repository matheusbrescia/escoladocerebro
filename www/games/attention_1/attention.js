$(document).ready(function ($) {
    ...
    function gamePscicotest() {
        ...
        $.each(res, function (i) {
            ...
            gamePage += '<button type="button" data-toggle="button"  class="btn btn-primary btn-board ">' + res[i] + '<img src="../../assets/img/pattern_1/ts' + res[i] + '.png" </img></button></div>';
...
//            }
//            if (nLevel == 2) {
//                $(".peaces-logo").append('<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6"><button type="button" data-toggle="button" id="cur_' + resp[i] + '" class="btn btn-primary col-xs-5 col-sm-5 col-md-5 col-lg-5 center-block">   <img src="../../assets/img/pattern_1/ts' + resp[i] + '.png" </img></button></div></div> ');
//            }
//            if (nLevel == 3) {
//                $(".peaces-logo").append('<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4"><button type="button" data-toggle="button" id="cur_' + resp[i] + '" class="btn btn-primary col-xs-4 col-sm-4 col-md-4 col-lg-4 center-block">   <img src="../../assets/img/pattern_1/ts' + resp[i] + '.png" </img></button></div></div> ');
//            }
        });
